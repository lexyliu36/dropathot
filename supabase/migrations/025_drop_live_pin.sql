-- Migration 025: Remove is_live_pin feature
-- The live-pin (poster location tracking) feature has been removed.

alter table thots drop column if exists is_live_pin;

-- Rebuild get_thots_nearby without is_live_pin
