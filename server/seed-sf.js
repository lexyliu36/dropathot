...
const THOTS = [
  ...
  { content: 'caught a double feature at the castro. one film from 1952. time is fake.',                     pen_name: 'DoubleFeatureFan',               lat: 37.7625, lng: -122.4351 },
  ...
  { content: '24th and mission at noon. this is the real san francisco that people move here for.',          pen_name: 'Real_SF_Local',               lat: 37.7525, lng: -122.4184 },
  ...
  { content: 'valencia street on a sunday: cyclists, brunch queues, and serious intentions.',                pen_name: 'ValenciaSunday',               lat: 37.7669, lng: -122.4214 },
  ...
  { content: 'broadway at 10pm. comedy clubs, strip clubs, tourists. block of maximum ambiguity.',           pen_name: 'BroadwayBlock',               lat: 37.7988, lng: -122.4063 },
  ...
  { content: 'golden gate park entrance at the panhandle. everyone is going somewhere slow.',               pen_name: 'PanhandleStroller',               lat: 37.7704, lng: -122.4445 },
  ...
  { content: 'hayes valley at noon on a tuesday. the most pleasant street in sf. change my mind.',          pen_name: 'HayesTuesdayFan',               lat: 37.7759, lng: -122.4225 },
  ...
  { content: 'fisherman\'s wharf at 7am before the sea lions get an audience. just you and them.',          pen_name: 'SeaLionWatcher',               lat: 37.8083, lng: -122.4177 },
  ...
  { content: 'sutro baths ruins at high tide. the ocean pours in and it still feels like ruins.',          pen_name: 'SutroBathGhost',               lat: 37.7801, lng: -122.5134 },
  ...
  { content: 'judah street muni. the N line. west toward the ocean. always some kind of adventure.',       pen_name: 'NlinePilgrim',               lat: 37.7637, lng: -122.4714 },
  ...
  { content: 'the church street hill. nobody talks about this view. everyone should.',                      pen_name: 'ChurchStHill',               lat: 37.7510, lng: -122.4280 },
  ...
  { content: 'glen park bart station. the BART plaza with the creek behind it. so strange. so good.',      pen_name: 'GlenParkCreek',               lat: 37.7332, lng: -122.4342 },
  ...
  { content: 'ggp on a wednesday afternoon. just people and ducks. the city dissolves.',                   pen_name: 'WednesdayDucks',               lat: 37.7694, lng: -122.4862 },
  ...
  { content: 'marina green at noon. kite festival energy even on regular days.',                           pen_name: 'MarinaGreenKid',               lat: 37.8039, lng: -122.4375 },
  ...
  { content: 'civic center at noon. public art, public everything. the complicated heart of the city.',    pen_name: 'CivicCenterGhost',               lat: 37.7793, lng: -122.4195 },
  ...
  { content: 'someone left an elaborate chalk mural on 18th. three people were crying looking at it.',    pen_name: 'ChalkMuralCrier',               lat: 37.7620, lng: -122.4264 },
  ...
  { content: 'the hills here are not a metaphor they are just genuinely steep. calves of steel required.', pen_name: 'HillCalves_SF',              lat: 37.7870, lng: -122.4320 },
...
async function seed() {
  ...
  const { data: _seedThots } = await supabase
    .from('thots').select('id').in('session_id', sfIds)
